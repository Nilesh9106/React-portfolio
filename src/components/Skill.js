            ...
            <section id="Skills">
                ...
                <div className=' px-5 mb-8'>
                    <div className="flex flex-wrap -m-4 text-center">
                        ...
                        <div className={"p-4 md:w-1/4 sm:w-1/2 hover:scale-105 duration-300 w-full"}>
                            <div className={"border-2 text-white hover:bg-[#092e20] duration-500 border-gray-800 px-4 py-6 rounded-lg"}>
                                <span className='text-5xl m-3 flex justify-center'>
                                    <SiDjango/>
                                </span>
                                <h2 className="title-font font-medium text-3xl text-white">Django</h2>
                                
                            </div>
                        </div>
                        <div className={"p-4 md:w-1/4 sm:w-1/2 hover:scale-105 duration-300 w-full"}>
                            <div className={"border-2 text-white hover:bg-[#3877ad] duration-500 border-gray-800 px-4 py-6 rounded-lg"}>
                                <span className='text-5xl m-3 flex justify-center'>
                                    <SiPython/>
                                </span>
                                <h2 className="title-font font-medium text-3xl text-white">Python</h2>
                                
                            </div>
                        </div>
                        <div className={"p-4 md:w-1/4 sm:w-1/2 hover:scale-105 duration-300 w-full"}>
                            <div className={"border-2 text-white hover:bg-[#0088c7] duration-500 border-gray-800 px-4 py-6 rounded-lg"}>
                                <span className='text-5xl m-3 flex justify-center'>
                                    <FaJava/>
                                </span>
                                <h2 className="title-font font-medium text-3xl text-white">Java</h2>
                                
                            </div>
                        </div>
                        <div className={"p-4 md:w-1/4 sm:w-1/2 hover:scale-105 duration-300 w-full"}>
                            <div className={"border-2 text-white hover:bg-[#67aa3c] duration-500 border-gray-800 px-4 py-6 rounded-lg"}>
                                <span className='text-5xl m-3 flex justify-center'>
                                    <SiSpring/>
                                </span>
                                <h2 className="title-font font-medium text-3xl text-white">Spring</h2>
